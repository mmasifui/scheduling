...
@Component({
  selector: 'app-repair-appointments',
  templateUrl: './repair-appointments.component.html',
  styleUrls: ['./repair-appointments.component.css']
})
export class RepairAppointmentsComponent implements OnInit {
